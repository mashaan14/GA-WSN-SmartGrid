%this M file try to discover new routes using GA with crossover strategy SEQ SEL CO
t1=tic;
source=40;
dest=13;
limit=1;
...
for r = 1:2:num(countIter)
    ...
    for i = random3:P_c                             %those two loops look for cut vertices in the parents from random start point
      ...
      %in case if there aren't any cut vertices just crossover from the half
